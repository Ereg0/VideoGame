...
# screen display dimentions and colors
...
# functions that move left paddle vertically 
...
#functions that move right paddles vertically
...
while True: 
    ...
    # code that tell bounces ball off paddles 
